        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 lg:grid-cols-12 lg:gap-12 lg:px-10 lg:py-20">
          ...
          <div className="flex flex-col justify-end lg:col-span-5">
            <p className="max-w-md text-base leading-relaxed text-foreground/80">
              Marindo is a thirty-six seat restaurant on a side street in Hudson. We cook over wood,
              write the menu each morning, and pour a short list of wines from growers we know by
              name.
            </p>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-12 lg:px-10">
          ...
          <div className="lg:col-span-4 lg:pt-16">
            <p className="text-base leading-relaxed text-foreground/80">
              Every plate begins at the fire — embers banked low, cast iron warming through the
              afternoon. We work with three farms within an hour's drive, and the menu changes the
              day a crate arrives.
            </p>
            <p className="mt-6 text-base leading-relaxed text-foreground/80">
              The result is unhurried, honest food. Pasta rolled at noon. Bread pulled at four. A
              short, considered list of dishes that taste like the week you eat them.
            </p>
            <Link
              to="/about"
              className="mt-8 inline-block text-sm uppercase tracking-[0.22em] text-foreground underline underline-offset-8"
            >
              Read more →
            </Link>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-2 lg:px-10">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-8 max-w-md text-base leading-relaxed text-foreground/80">
              Chef Elena Marindo opened the restaurant in 2014 after a decade cooking in Piedmont
              and the Catskills. Her cooking is precise, warm, and quietly seasonal.
            </p>
            <Link to="/about" className="mt-8 btn-ghost self-start">
              About the kitchen
            </Link>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
          <div className="flex items-end justify-between border-b border-border pb-8">
            <div>
              ...
              <h2 className="mt-3 font-display text-5xl text-foreground lg:text-6xl">
                From the menu
              </h2>
            </div>
            <Link
              to="/menu"
              className="hidden text-sm uppercase tracking-[0.22em] text-foreground underline underline-offset-8 sm:inline-block"
            >
              Full menu →
            </Link>
          </div>
          ...
          <div className="mt-12 grid gap-12 lg:grid-cols-3">
            {[
              {
                name: "Cured trout, fennel, brown butter",
                note: "Catskill farm trout cured in salt and citrus, plated with shaved fennel.",
                price: "18",
              },
              {
                name: "Bucatini, pepper, anchovy",
                note: "Roasted summer peppers folded into anchovy-laced butter and aged parmesan.",
                price: "24",
              },
              {
                name: "Hearth chicken, jus, greens",
                note: "Half a bird cooked slowly over apple wood, served with bitter greens.",
                price: "32",
              },
            ].map((d, i) => (
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-4xl px-6 py-28 text-center lg:px-10">
          ...
          <blockquote className="mt-8 font-display text-4xl leading-snug text-foreground lg:text-5xl">
            "One of the most quietly confident kitchens in the Hudson Valley — every plate is
            restrained, every flavor exact."
          </blockquote>
      ...
      <section>
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-2 lg:px-10">
          <div className="flex flex-col justify-center">
            ...
            <h2 className="mt-6 font-display text-5xl leading-tight text-foreground lg:text-6xl">
              A small dining room.
              <br />A short waiting list.
            </h2>
            <p className="mt-6 max-w-md text-base leading-relaxed text-foreground/80">
              We open reservations thirty days in advance. Walk-ins welcome at the bar from 5:30,
              where you'll find the full menu and an espresso at the close.
            </p>
            <div className="mt-8">
              <Link to="/reservations" className="btn-primary">
                Book a table
